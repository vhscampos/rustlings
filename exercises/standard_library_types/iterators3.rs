...
pub fn divide(a: i32, b: i32) -> Result<i32, DivisionError> {
    ...
    match a % b {
        0 => Ok(a/b),
        other => Err(DivisionError::NotDivisible(NotDivisibleError {dividend: a, divisor: b}))
    }
}
...
mod tests {
    ...
    fn result_with_list() {
        ...
        let x : Result<Vec<i32>, DivisionError> = division_results.collect::<Vec<_>>().into_iter().collect();
